...
func Test_checkConfig(t *testing.T) {
	t.Run("unknownDataType", func(t *testing.T) {
		assert.Panics(t, func() {
			data.RegisterInternalContext("Database.test_oracle", "DataType=oracle,PoolMaxSize=5,PoolMinSize=1,ConnectionString=root:qwe123@tcp(192.168.1.8:3306)/test?charset=utf8&parseTime=True&loc=Local")
