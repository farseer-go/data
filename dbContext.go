...
func InitContext[TDbContext IDbContext](repositoryContext *TDbContext, dbName string, autoCreateTable bool) {
	...
	dbContext := container.Resolve[core.ITransaction](dbName).(*DbContext)
...
// Begin 开启事务
func (receiver *DbContext) Begin(isolationLevels ...sql.IsolationLevel) {
...
// Transaction 使用事务
func (receiver *DbContext) Transaction(executeFn func()) {
	receiver.Begin()
	executeFn()
	receiver.Commit()
}
...
// Commit 事务提交
func (receiver *DbContext) Commit() {
	routineOrmClient.Get().Commit()
	routineOrmClient.Remove()
}

// Rollback 事务回滚
func (receiver *DbContext) Rollback() {
